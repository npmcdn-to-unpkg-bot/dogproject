...
return array(
	 ...
	 *	)
	 */
	'menu' => array('users','Sellers'=>array ('sellers','seller_enquiry','seller_reviews','verification','hobby_verification'),'Shelters' => array('shelters','shelter_key_members','shelter_enquiry','shelter_reviews'),'Association' => array('associations','association_members','key_members','requests'), 'admins'),
    //,'shelters','associations','dogs','staff_picks',
	...
	{
		return true;
        //dd($user=Auth::driver('database')->user());
	 ...
	 * @type string
	 */
	'back_to_site_path' => 'http://petagree/admin-login',
	 ...
	 * @type string
	 */
	'login_path' => 'http://petagree/admin-login',
